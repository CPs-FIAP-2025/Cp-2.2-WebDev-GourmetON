            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4">
              {categories.map((category) => (
                <div 
                  ...
                  className="text-center p-3 sm:p-4 rounded-lg bg-[#00000015] hover:bg-[#00000030] hover:shadow-md transition-all cursor-pointer border-2 border-transparent hover:border-primary-new"
                >
                  <img 
