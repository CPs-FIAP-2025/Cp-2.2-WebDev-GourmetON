...
const ContactSection = () => {
  return (
    <section id="contato" className="py-20 bg-[#364e36]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="max-w-sm sm:max-w-md mx-auto px-4 sm:px-0">
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            />
            <Button className="bg-[#00000065] text-white hover:bg-[#00000083] px-6 sm:px-8 py-3 font-semibold text-sm sm:text-base shadow-lg">
              Assinar
            </Button>
          </div>
        </div>
